 ...
 <!--main content start-->
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-laptop"></i>Gestão do Banner</h3>
                <ol class="breadcrumb">
                    <li><i class="fa fa-home"></i><a href="{{url('/painel')}}">Home</a></li>
                    <li><i class="fa fa-laptop"></i><a href="{{url('/painel/banner')}}">Banner</a></li>
                    <li><i class="fa fa-laptop"></i>Gestão de Banner</li>
                </ol>
                </div>
            </div> 
...
<div class="panel-body">
    ...
    @endif
        ...
        {!! Form::open(['route' => ['banner.destroy', $data ->id], 'class' => 'form form-search form-ds', 'method' => 'DELETE'])  !!}
