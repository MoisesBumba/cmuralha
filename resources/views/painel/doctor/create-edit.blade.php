 ...
 <!--main content start-->
        ...
        <section class="wrapper">
            ...
            <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><i class="fa fa-laptop"></i><a href="{{url('/painel/doctor')}}">Doutores</a></li>
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            ...
            @endif
        @if (isset($data ))
        {!! Form::model($data , ['route' => ['doctor.update', $data ->id], 'class' => 'form form-search form-ds', 'files' => true, 'method' => 'PUT'])  !!}
        @else
                {!! Form::open(['route' => 'doctor.store', 'class' => 'form form-search form-ds', 'files' => true])  !!}
        @endif
            <div class="form-group">
                {!! Form::text('name', null, ['placeholder' => 'Nome:', 'class' => 'form-control']) !!}
            </div>
            <div class="form-group">
                {!! Form::text('specialty', null, ['placeholder' => 'Especialidade:', 'class' => 'form-control']) !!}
            </div>
            <div class="form-group">
