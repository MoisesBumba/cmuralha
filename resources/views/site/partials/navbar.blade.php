	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="#department-section" class="nav-link"><span>Serviços Médicos</span></a></li>
	          <li class="nav-item"><a href="#doctor-section" class="nav-link"><span>Doutores</span></a></li>
	          <li class="nav-item"><a href="#blog-section" class="nav-link"><span>Noticias</span></a></li>
	          <li class="nav-item"><a href="#contact-section" class="nav-link"><span>Contactos</span></a></li>
	          <li class="nav-item cta mr-md-2"><a href="appointment.html" class="nav-link">Marcação de Consultas</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
